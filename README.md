...
[![tests](https://github.com/immunosystemsbiology.github.io/Retro.jl/actions/workflows/tests.yml/badge.svg)](https://github.com/max-de-rooij/Retro.jl/actions/workflows/tests.yml)
...
> [!IMPORTANT]
> To use `Retro.jl` with an automatic differentiation backend (other than `ForwardDiff.jl`), you need to import that separately.
